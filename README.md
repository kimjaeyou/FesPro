# 서울 컬투
KOSTA_286기 Web 2차 미니프로젝트

## 개요
- 프로젝트 명 : 서울 컬투
- 팀 명 : 푸바오 캐리해조
- 팀원 : 이인영, 강윤성, 김재영, 염진, 이성민, 최재구, 정형우
- 프로젝트 개요 :
  실제 시에서 운영하는 공공행사 예약 서비스 내용을 기반으로 하여 해당 프로젝트를 통해 주최자와 참여자 간 서비스 정보의 제공과 예약 기능을 제공하고 관리자에게는 회원관리 및 행사관리 기능 등을 제공합니다
...
- [DB 모델링](https://www.erdcloud.com/d/nBf9CpJ32WFivAWEP)
- [시연 영상](https://youtu.be/gH35oCDz2DQ?si=7MWf-6sHDmZ2nkVQ)
- [발표 자료](https://www.figma.com/deck/jaPFLu5eK3A5giEkwkMcGB/SeoulCulture?node-id=1-3059&t=ZzwOm6vvAu0CMZoI-1)

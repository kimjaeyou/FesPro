...
public class FesDTO {
	...
	public FesDTO(String sVCID, String mAXCLASSNM, String mINCLASSNM, String sVCSTATNM, String sVCNM, String pAYATNM,
			String pLACENM, String uSETGTINFO, String x, String y, String sVCOPNBGNDT, String sVCOPNENDDT,
			String rCPTBGNDT, String aREANM, String iMGURL, String dTLCONT, String tELNO, String v_MAX, String v_MIN,
			String rEVSTDDAY, String rEVSTDDAYNM, int fes_state, String update_date, int mAXNUM, int pRICE,
			int host_seq) {
		super();
		SVCID = sVCID;

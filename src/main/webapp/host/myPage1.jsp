		...
		<nav class="sb-sidenav accordion sb-sidenav-white"
			...
			<div class="sb-sidenav-menu">
				<div class="nav">
					...
					</a> <a class="nav-link" href="myPage2.jsp">
						<div class="sb-nav-link-icon">
							<i class="fas fa-tachometer-alt"></i>
						</div> 회원 정보 변경
					</a>
								...
								<c:choose>
									<c:when test="${empty requestScope.FesDTOList}" var="FesDTO">
										<tr>
											<td colspan="7">
												<p align="center">
													<b><span style="font-size: 9pt;">등록된 행사가 없습니다.</span></b>
												</p>
											</td>
										</tr>
									</c:when>
									<c:otherwise>
										<c:forEach items="${requestScope.FesDTOList}" var="FesDTO">
											<td>
												<p align="center">
													<span style="font-size: 9pt;">${FesDTO.SVCID}</span>
												</p>
											</td>
											<td>
												<p align="center">
													<span style="font-size: 9pt;">${FesDTO.SVCNM}</span>
												</p>
											</td>
											<td>
												<p align="center">
													<span style="font-size: 9pt;">${FesDTO.SVCSTATNM}</span>
												</p>
											</td>
											<td>
												<p align="center">
													<span style="font-size: 9pt;">${FesDTO.Update_date}</span>
												</p>
											</td>
											<td>
												<p align="center">
													<span style="font-size: 9pt;">${FesDTO.Fes_state}</span>
												</p>
											</td>
											<td>
												<p align="center">
													<span style="font-size: 9pt;"><a href="#"></a></span>
												</p>
											</td>
										</c:forEach>
									</c:otherwise>

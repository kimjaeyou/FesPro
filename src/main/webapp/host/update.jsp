    	...
    	<tbody>
        	...
        	<tr>
        		...
        		<td><p align="center"><span>
        			<label><input type="radio" name="MINCLASSNM" value="교육체험" ${fesDTO.MINCLASSNM == '교육체험' ? 'checked' : ''}>교육체험</label>
        			<label><input type="radio" name="MINCLASSNM" value="농장체험" ${fesDTO.MINCLASSNM == '농장체험' ? 'checked' : ''}>농장체험</label>
        			<label><input type="radio" name="MINCLASSNM" value="문화행사" ${fesDTO.MINCLASSNM == '문화행사' ? 'checked' : ''}>문화행사</label>
        			<label><input type="radio" name="MINCLASSNM" value="전시/관람" ${fesDTO.MINCLASSNM == '전시/관람' ? 'checked' : ''}>전시/관람</label>
        			<label><input type="radio" name="MINCLASSNM" value="단체봉사" ${fesDTO.MINCLASSNM == '단체봉사' ? 'checked' : ''}>단체봉사</label>
        			<label><input type="radio" name="MINCLASSNM" value="공원탐방" ${fesDTO.MINCLASSNM == '공원탐방' ? 'checked' : ''}>공원탐방</label>
        			<label><input type="radio" name="MINCLASSNM" value="서울형키즈카페" ${fesDTO.MINCLASSNM == '서울형키즈카페' ? 'checked' : ''}>서울형키즈카페</label>
        			<label><input type="radio" name="MINCLASSNM" value="산림여가" ${fesDTO.MINCLASSNM == '산림여가' ? 'checked' : ''}>산림여가</label>
        		</span></p></td>
        	</tr>
        	<tr>
        		<td><p align="center"><span>서비스상태</span></p></td>
        		<td><p align="center"><span>
        			<label><input type="radio" name="SVCSTATNM" value="안내중" ${fesDTO.SVCSTATNM == '안내중' ? 'checked' : ''}>안내중</label>
        			<label><input type="radio" name="SVCSTATNM" value="접수중" ${fesDTO.SVCSTATNM == '접수중' ? 'checked' : ''}>접수중</label>
        			<label><input type="radio" name="SVCSTATNM" value="접수종료" ${fesDTO.SVCSTATNM == '접수종료' ? 'checked' : ''}>접수종료</label>
        			<label><input type="radio" name="SVCSTATNM" value="예약마감" ${fesDTO.SVCSTATNM == '예약마감' ? 'checked' : ''}>예약마감</label>
        			<label><input type="radio" name="SVCSTATNM" value="예약일시중지" ${fesDTO.SVCSTATNM == '예약일시중지' ? 'checked' : ''}>예약일시중지</label>
        		</span></p></td>
        	</tr>
        	<tr>
        	...
        	<tr>
        		...
        		<td><p align="center"><span>
        			<label><input type="radio" name="PAYATNM" value="무료" ${fesDTO.PAYATNM == '무료' ? 'checked' : ''}>무료</label>
        			<label><input type="radio" name="PAYATNM" value="유료" ${fesDTO.PAYATNM == '유료' ? 'checked' : ''}>유료</label>
        		</span></p></td>
        	</tr>
        	<tr>
        		<td><p align="center"><span>서비스대상</span></p></td>
        		<td><p align="center"><span>
        			<label><input type="radio" name="USETGTINFO" value="유아" ${fesDTO.USETGTINFO == '유아' ? 'checked' : ''}>유아</label>
        			<label><input type="radio" name="USETGTINFO" value="초등학생" ${fesDTO.USETGTINFO == '초등학생' ? 'checked' : ''}>초등학생</label>
        			<label><input type="radio" name="USETGTINFO" value="중학생" ${fesDTO.USETGTINFO == '중학생' ? 'checked' : ''}>중학생</label>
        			<label><input type="radio" name="USETGTINFO" value="고등학생" ${fesDTO.USETGTINFO == '고등학생' ? 'checked' : ''}>고등학생</label>
        			<label><input type="radio" name="USETGTINFO" value="성인" ${fesDTO.USETGTINFO == '성인' ? 'checked' : ''}>성인</label>
        		</span></p></td>
        	</tr>
        	<tr>
        		<td><p align="center"><span>서비스 개시 시작일시</span></p></td>
        		<td><p align="center"><span><label><input type="date" name="SVCOPNBGNDT" value="${fn:substring(fesDTO.SVCOPNBGNDT, 0, 10)}"></label></span></p></td>
        	</tr>
        	<tr>
        		<td><p align="center"><span>서비스 개시 종료일시</span></p></td>
        		<td><p align="center"><span><label><input type="date" name="SVCOPNENDDT" value="${fn:substring(fesDTO.SVCOPNENDDT, 0, 10)}"></label></span></p></td>
        	</tr>
        	<tr>
        		<td><p align="center"><span>접수 시작일시</span></p></td>
        		<td><p align="center"><span><label><input type="date" name="RCPTBGNDT" value="${fn:substring(fesDTO.RCPTBGNDT, 0, 10)}"></label></span></p></td>
        	</tr>
        	<tr>
        		<td><p align="center"><span>접수 종료일시</span></p></td>
        		<td><p align="center"><span><label><input type="date" name="RCPTENDDT" value="${fn:substring(fesDTO.RCPTENDDT, 0, 10)}"></label></span></p></td>
        	</tr>
        	<tr>
        	...
        	<tr>
        		...
        		<td><p align="center"><span>
        			<label><input type="radio" name="REVSTDDAYNM" value="접수종료일" ${fesDTO.REVSTDDAYNM == '접수종료일' ? 'checked' : ''}>접수종료일</label>
        			<label><input type="radio" name="REVSTDDAYNM" value="이용일" ${fesDTO.REVSTDDAYNM == '이용일' ? 'checked' : ''}>이용일</label>
        			<label><input type="radio" name="REVSTDDAYNM" value="이용기간시작일" ${fesDTO.REVSTDDAYNM == '이용기간시작일' ? 'checked' : ''}>이용기간시작일</label>
        		</span></p></td>
        	</tr>
        	<tr>

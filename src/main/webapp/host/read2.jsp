...
<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
	<thead>
		<tr>
 			<th style="background-color: #eeeeee; text-align: center;" colspan="2">서비스 등록/수정 신청내역</th>
       	</tr>
	</thead>
	<tbody>
		<tr>
			<td><p align="center"><span>서비스아이디</span></p></td>
			<td><p align="center"><span><b>${waitFes.SVCID}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>대분류명</span></p></td>
			<td><p align="center"><span><b>${waitFes.MAXCLASSNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>소분류명</span></p></td>
			<td><p align="center"><span><b>${waitFes.MINCLASSNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스상태</span></p></td>
			<td><p align="center"><span><b>${waitFes.SVCSTATNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스명</span></p></td>
			<td><p align="center"><span><b>${waitFes.SVCNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>결제방법</span></p></td>
			<td><p align="center"><span><b>${waitFes.PAYATNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스대상</span></p></td>
			<td><p align="center"><span><b>${waitFes.USETGTINFO}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스개시시작일시</span></p></td>
			<td><p align="center"><span><b>${waitFes.SVCOPNBGNDT}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스개시종료일시</span></p></td>
			<td><p align="center"><span><b>${waitFes.SVCOPNENDDT}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>접수시작일시</span></p></td>
			<td><p align="center"><span><b>${waitFes.RCPTBGNDT}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>접수종료일시</span></p></td>
			<td><p align="center"><span><b>${waitFes.RCPTENDDT}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>지역명</span></p></td>
			<td><p align="center"><span><b>${waitFes.AREANM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>장소명</span></p></td>
			<td><p align="center"><span><b>${waitFes.PLACENM}</b></span></p></td>
		</tr>
		<!--<tr>
		...
		<tr>
			...
			<td><p align="center"><span><b>${waitFes.IMGURL}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>상세내용</span></p></td>
			<td><p align="center"><span><b>${waitFes.DTLCONT}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>전화번호</span></p></td>
			<td><p align="center"><span><b>${waitFes.TELNO}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스이용 시작시간</span></p></td>
			<td><p align="center"><span><b>${waitFes.getV_MIN()}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>서비스이용 종료시간</span></p></td>
			<td><p align="center"><span><b>${waitFes.getV_MAX()}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>취소기간 기준정보</span></p></td>
			<td><p align="center"><span><b>${waitFes.REVSTDDAYNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>취소기간 기준일까지</span></p></td>
			<td><p align="center"><span><b>${waitFes.REVSTDDAY}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>등록신청 정보</span></p></td>
			<td>
                        								<p align="center"><span>
                        								<c:set var="fesState" value="${waitFes.getFes_state()}" />
                        								<c:choose>
		...
		<tr>
			...
			<td><p align="center"><span><b>${waitFes.getUpdate_date()}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>최대 인원수</span></p></td>
			<td><p align="center"><span><b>${waitFes.MAXNUM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>가격</span></p></td>
			<td><p align="center"><span><b>${waitFes.PRICE}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>주최자 sequence</span></p></td>
			<td><p align="center"><span><b>${waitFes.host_seq}</b></span></p></td>
		</tr>
		<tr>

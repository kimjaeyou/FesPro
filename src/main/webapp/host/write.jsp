								...
								<table class="table table-striped"
									...
									<tbody>
										...
										<tr>
											...
											<td><p align="center">
													<span> <label><input type="radio"
															name="MINCLASSNM" value="교육체험">교육체험</label> <label><input
															type="radio" name="MINCLASSNM" value="농장체험">농장체험</label>
														<label><input type="radio" name="MINCLASSNM"
															value="문화행사">문화행사</label> <label><input
															type="radio" name="MINCLASSNM" value="전시/관람">전시/관람</label>
														<label><input type="radio" name="MINCLASSNM"
															value="단체봉사">단체봉사</label> <label><input
															type="radio" name="MINCLASSNM" value="공원탐방">공원탐방</label>
														<label><input type="radio" name="MINCLASSNM"
															value="서울형키즈카페">서울형키즈카페</label> <label><input
															type="radio" name="MINCLASSNM" value="산림여가">산림여가</label>
													</span>
												</p></td>
										</tr>
										<tr>
											...
											<td><p align="center">
													<span> <label><input type="radio"
															name="SVCSTATNM" value="안내중">안내중</label> <label><input
															type="radio" name="SVCSTATNM" value="접수중">접수중</label> <label><input
															type="radio" name="SVCSTATNM" value="접수종료">접수종료</label> <label><input
															type="radio" name="SVCSTATNM" value="예약마감">예약마감</label> <label><input
															type="radio" name="SVCSTATNM" value="예약일시중지">예약일시중지</label>
													</span>
												</p></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><p align="center">
													<span> <label><input type="radio"
															name="PAYATNM" value="무료">무료</label> <label><input
															type="radio" name="PAYATNM" value="유료">유료</label>
													</span>
												</p></td>
										</tr>
										<tr>
											...
											<td><p align="center">
													<span> <label><input type="radio"
															name="USETGTINFO" value="유아">유아</label> <label><input
															type="radio" name="USETGTINFO" value="초등학생">초등학생</label>
														<label><input type="radio" name="USETGTINFO"
															value="중학생">중학생</label> <label><input
															type="radio" name="USETGTINFO" value="고등학생">고등학생</label>
														<label><input type="radio" name="USETGTINFO"
															value="성인">성인</label>
										...
										<tr>
											...
											<td><p align="center">
													<span> <label><input type="radio"
															name="REVSTDDAYNM" value="접수종료일">접수종료일</label> <label><input
															type="radio" name="REVSTDDAYNM" value="이용일">이용일</label> <label><input
															type="radio" name="REVSTDDAYNM" value="이용기간시작일">이용기간시작일</label>
													</span>
												</p></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td width="1000"><p align="center">
												...
												<div id="map" style="width: 100%; height: 350px;"></div> <label>위도:
													<input type="text" id="latitude" name="Y" readonly>

	...
	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
    	...
    	<tbody>
        	...
        	<tr>
        		...
        		<td><p align="center"><span>
        		<label><input type="checkbox" name="tag_content" value="가족">가족</label>
        		<label><input type="checkbox" name="tag_content" value="효도">효도</label>
        		<label><input type="checkbox" name="tag_content" value="연인">연인</label>
        		<label><input type="checkbox" name="tag_content" value="학습">학습</label>
        		<label><input type="checkbox" name="tag_content" value="건강">건강</label>
        		<label><input type="checkbox" name="tag_content" value="키즈">키즈</label></span></p></td>
        	</tr>
        	<tr>

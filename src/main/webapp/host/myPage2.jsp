...
<html lang="en">
    ...
    <script>
function sendUpdate(){
	document.requestForm.methodName.value ="pwUpdateForm";
...
<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
	...
	<tbody>
		<tr>
			<td><p align="center"><span>기업 시퀀스</span></p></td>
		...
		<tr>
			<td><p align="center"><span>기업 비밀번호</span></p></td>
			<td><p align="center"><span><b>${fesDTO.MINCLASSNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>기업 전화번호</span></p></td>
			<td><p align="center"><span><b>${fesDTO.SVCSTATNM}</b></span></p></td>
		</tr>
		<tr>
			<td><p align="center"><span>회원명</span></p></td>
